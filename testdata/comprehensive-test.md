# Fluence Comprehensive Test Page

This page tests all Markdown features supported by the fluence CLI tool. Use this page to verify bidirectional conversion between Markdown and Confluence storage format.
...
# Build the project
go build -o fluence -ldflags "-X main.version=v1.0.0"
...
_Generated for fluence CLI testing purposes._
